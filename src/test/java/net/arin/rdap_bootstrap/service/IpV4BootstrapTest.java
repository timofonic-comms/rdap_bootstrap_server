...
public class IpV4BootstrapTest
{
	...
	public void testAllocations() throws Exception
	{
		...
		// assertEquals( "http://rdap.iana.org", v4.getServiceUrls( 0
		// ).getHttpUrl() );
		...
		// Testing for NIR's resources
		assertEquals("https://rdap.registro.br", v4.getServiceUrls("200.160.0.1").getHttpsUrl());
	}
}
