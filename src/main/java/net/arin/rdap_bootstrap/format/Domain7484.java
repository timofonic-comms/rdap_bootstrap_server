 ...
 * @version $Rev$, $Date$
 */
public class Domain7484 implements Format, Rfc7484.Handler
{
    private Store.Domain store;
    ...
    {
        store.store( entry.toUpperCase(), serviceUrls );
    }
